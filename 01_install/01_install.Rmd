...
我再啰嗦几句，课时有限，要想掌握这门技术，需要课后多下功夫。

1、请务必配置好环境，包括安装宏包（群里有安装视频，实在不行，@我远程协助）
2、学习资料 https://bookdown.org/wangminjie/R4DS/
3、强烈推荐参考书目《R数据科学》（群文件book文件夹中）
4、我们不是孙悟空，一出生就身怀绝技。No shame in asking help
5、学习曲线会比较陡，但有老司机带路，要有信心。
